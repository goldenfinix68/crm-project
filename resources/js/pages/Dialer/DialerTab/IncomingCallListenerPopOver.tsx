...
const IncomingCallListenerPopOver = () => {
    ...
    const dialerTabs: TabsProps["items"] = [
        {
            key: "1",
            label: <div style={{ fontSize: "12px" }}>DIALER</div>,
            children: (
                <DialerTab
        ...
        {
            key: "3",
            label: <div style={{ fontSize: "12px" }}>RECENT</div>,
            children: <RecentTab />,
        },
        // {
        //     key: "4",
...
export default IncomingCallListenerPopOver;
