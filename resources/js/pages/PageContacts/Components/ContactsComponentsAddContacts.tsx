...
const ContactsComponentsAddContacts: React.FC<
            ...
            >
                ...
                <div className="modal-content">
                    ...
                    <Row gutter={24} className="m-b-md">
                        <Col md={12} xs={12}>
                            <Typography className="m-b-xs">Mobile</Typography>
                    ...
                    <Row gutter={24} className="m-b-md">
                        ...
                        <Col md={12} xs={12}>
                            <Typography className="m-b-xs">Email</Typography>
                    ...
                    <Row gutter={24} className="m-b-md">
                        ...
                        <Col md={12} xs={12}>
                            <Typography className="m-b-xs">Phone</Typography>
                    ...
                    <Row gutter={24} className="m-b-md">
                        <Col md={12} xs={12}>
                            <Typography className="m-b-xs">Email 2</Typography>
                    ...
                    <Row gutter={24} className="m-b-md">
                        ...
                        <Col md={12} xs={12}>
                            ...
                            <Checkbox className={"m-t-lg"} onChange={onChange}>
                                Email Opt Out
                            </Checkbox>
                        </Col>
                    </Row>
