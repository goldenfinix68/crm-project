...
Route::middleware('auth:api')->group(function () {
    ...
    Route::post('/deals/count', 'App\Http\Controllers\Api\DealsController@count');
    Route::post('/deals/deals-by-stage', 'App\Http\Controllers\Api\DealsController@dealsByStageId');
